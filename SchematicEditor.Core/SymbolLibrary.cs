...
public static class SymbolLibrary
{
    ...
    private static List<SymbolDefinition> Build()
    {
        ...
        list.Add(new SymbolDefinition("Resistor", "R", "10k",
            new[] { new PinDefinition("1", V(-20, 0)), new PinDefinition("2", V(20, 0)) },
            new DrawPrimitive[]
            {
                L(-20, 0, -10, 0), L(10, 0, 20, 0),
                new PolyPrim(new[] { V(-10, -4), V(10, -4), V(10, 4), V(-10, 4) }, Closed: true, Filled: false),
            }));

        // Capacitor, horizontal.
        list.Add(new SymbolDefinition("Capacitor", "C", "100n",
            new[] { new PinDefinition("1", V(-20, 0)), new PinDefinition("2", V(20, 0)) },
            new DrawPrimitive[]
            {
        ...
        list.Add(new SymbolDefinition("Inductor", "L", "10m",
            new[] { new PinDefinition("1", V(-20, 0)), new PinDefinition("2", V(20, 0)) },
            new DrawPrimitive[]
            {
        ...
        // Diode, anode left.
        list.Add(new SymbolDefinition("Diode", "D", "1N4148",
            new[] { new PinDefinition("A", V(-20, 0)), new PinDefinition("K", V(20, 0)) },
            new DrawPrimitive[]
            {
                L(-20, 0, -6, 0), L(6, 0, 20, 0),
                new PolyPrim(new[] { V(-6, -6), V(-6, 6), V(6, 0) }, Closed: true, Filled: true),
                L(6, -6, 6, 6),
            }));

        // Ground (earth), single pin on top.
        list.Add(new SymbolDefinition("Ground", "GND", "",
            new[] { new PinDefinition("1", V(0, 0)) },
            new DrawPrimitive[]
            {
                L(0, 0, 0, 6),
        ...
        list.Add(new SymbolDefinition("VSource", "V", "5V",
            new[] { new PinDefinition("+", V(0, -20)), new PinDefinition("-", V(0, 20)) },
            new DrawPrimitive[]
            {
        ...
        list.Add(new SymbolDefinition("ACSource", "V", "5V 50Hz",
            new[] { new PinDefinition("+", V(0, -20)), new PinDefinition("-", V(0, 20)) },
            new DrawPrimitive[]
            {
                L(0, -20, 0, -10), L(0, 10, 0, 20),
        ...
        list.Add(new SymbolDefinition("Battery", "BT", "9V",
            new[] { new PinDefinition("+", V(0, -20)), new PinDefinition("-", V(0, 20)) },
            new DrawPrimitive[]
            {
        ...
        list.Add(new SymbolDefinition("Lamp", "E", "12V 5W",
            new[] { new PinDefinition("1", V(-20, 0)), new PinDefinition("2", V(20, 0)) },
            new DrawPrimitive[]
            {
        ...
        list.Add(new SymbolDefinition("Switch", "S", "",
            new[] { new PinDefinition("1", V(-20, 0)), new PinDefinition("2", V(20, 0)) },
            new DrawPrimitive[]
            {
                L(-20, 0, -10, 0), L(10, 0, 20, 0),
            ...
            onPrimitives: new DrawPrimitive[]
            {
                L(-20, 0, -10, 0), L(10, 0, 20, 0),
                new CirclePrim(V(-10, 0), 1.5, Filled: false),
                new CirclePrim(V(10, 0), 1.5, Filled: false),
        ...
        list.Add(new SymbolDefinition("Fuse", "F", "1A",
            new[] { new PinDefinition("1", V(-20, 0)), new PinDefinition("2", V(20, 0)) },
            new DrawPrimitive[]
            {
                L(-20, 0, 20, 0),
        ...
        list.Add(new SymbolDefinition("NPN", "Q", "BC547",
            new[]
            {
            ...
            new DrawPrimitive[]
            {
                ...
                L(-4, 4, 10, 14), L(10, 14, 10, 20),
                new PolyPrim(new[] { V(10, 14), V(4.8, 12.7), V(7.1, 9.4) }, Closed: true, Filled: true),
            }));
